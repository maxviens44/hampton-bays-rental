...
export default function Header() {
  ...
  return (
    <header
      id="top"
      className="relative px-4 md:px-10 py-3 md:py-5 border-b sticky top-0 bg-white md:bg-white/90 backdrop-blur md:backdrop-blur z-40"
    >
      <div className="max-w-7xl mx-auto flex items-center justify-between gap-3">
        ...
        <nav className="hidden md:flex items-center gap-5 text-sm">
          ...
          <NavLink to="/info" className={base}>Info</NavLink>
      ...
      {open && (
        <div className="md:hidden absolute left-0 right-0 top-full bg-white border-b shadow-lg">
          <nav className="px-4 py-3 grid gap-1 text-base">
            ...
            <NavLink to="/info" className={mobileItem}>Info</NavLink>
