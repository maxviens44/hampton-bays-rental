...
/* ────────────────────────────────────────────────────────── *
 * App root for the home route
 * ────────────────────────────────────────────────────────── */
export default function App() {
  useEffect(() => {
    const h = window.location.hash
    const id = h && h.startsWith("#") ? h.slice(1) : ""
    if (id) {
      setTimeout(() => {
    ...
    if (meta) meta.setAttribute("content", "Classic cedar shingle Hamptons house rental with heated saltwater pool, 4BR/5BA, near Shinnecock Hills.")
  }, [])
