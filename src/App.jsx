...
const images = [
  ...
  { file: "livingroom2.webp", label: "Living Room View" },
  { file: "livingroom3.webp", label: "Living Room Detail" },
  { file: "kitchen1.webp", label: "Chef's Kitchen" },
  { file: "kitchen2.webp", label: "Chef's Kitchen" },
  { file: "kitchen3.webp", label: "Chef's Kitchen" },
  { file: "kitchenangle.webp", label: "Chef's Kitchen" },
  { file: "dining.webp", label: "Dining Area" },
  { file: "diningroomfinal.webp", label: "Dining Area" },
  ...
  { file: "primary1.webp", label: "Primary Bedroom" },
  { file: "primary2.webp", label: "Primary Suite" },
  { file: "primary3.webp", label: "Primary Doors to Balcony" },
  ...
  { file: "basementlivingroom1.webp", label: "Finished Basement" },
        ...
        <div className="max-w-3xl mx-auto">
          ...
          <div className="space-y-4 text-neutral-800">
            ...
            <ul className="list-disc pl-5 space-y-1">
              ...
              <li>Main level includes two en-suite bedrooms with direct patio access and pool.</li>
...
function InfoPage() {
  ...
  const restaurants = [
    { town: "Hampton Bays", name: "Rumba (Personal favorite)", url: "https://tasterumba.com/hampton-bays-ny/", desc: "Caribbean inspired spot on the water with fish tacos and rum drinks" },
    { town: "Hampton Bays", name: "Cowfish (Personal favorite)", url: "https://cowfishrestaurant.com/", desc: "Waterfront seafood, sushi, and steaks with canal views" },
    ...
    { town: "Southampton", name: "Union Burger Bar (Personal favorite)", url: "https://unionburgerbar.com/", desc: "Casual pub for gourmet burgers and craft beer. Very kids friendly" },
    ...
    { town: "Sag Harbor", name: "Le Bilboquet (Personal favorite)", url: "https://lebilboquetsag.com/", desc: "Upscale waterfront French inspired seafood and lively scene" },
